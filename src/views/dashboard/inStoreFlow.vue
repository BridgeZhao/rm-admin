  ...
  <div class="app-container reportInput" style="background:none">
    <div class="top">
      <div style="float: left;margin-left: 1%;">
        <label-view label-father="进店客流统计" />
      </div>
          ...
          <el-col :span="12">
            <div class="grid-content bg-purple report-line">
              ...
              <div style="width:100%;height:100%;">
                <pie-chart ref="客流类型分布" :data="vipData" :height="chartHeight" />
              </div>
            </div>
          </el-col>
          <el-col :span="12">
            <div class="grid-content bg-purple report-line">
              ...
              <div style="width:100%;height:100%;">
                <bar-chart-age ref="客流年龄分布" :data="ageData" :height="chartHeight" />
              </div>
            </div>
          </el-col>
        </el-row>
        <el-row :gutter="24" class="report-margin">
          <el-col :span="24">
            <div class="grid-content bg-purple report-line">
              ...
              <div style="width:100%;height:100%;">
                <people-chart ref="小时客流趋势" :data-list="hourPeopleData" :height="chartHeight" :show-num="isShow" />
              </div>
            </div>
          </el-col>
        </el-row>
    ...
    data(){
     ...
     methods:{
        ...
        init(storeId){
            ...
            const _params = {store_id:_storeId,starttime:start_time,endtime:start_time,hh:'08,22'}
