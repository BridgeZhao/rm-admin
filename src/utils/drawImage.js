...
export class DrawImage {
	...
	init(point_data) {
		...
		this.canvas.onmousemove = (ev) => {
			...
			const _point = this.prointAry[this.aryNum].data
			const {isSelect}=checkSelect.call(this,ev,_point)
			if(isSelect){
...
function checkSelect(ev,point) {
	...
	return {isSelect:_isSelect,rectBox:rect}
}
